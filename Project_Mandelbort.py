...
def reset_params():
    ...
    x_max_entry.insert(0,"1.5")
    y_max_entry.insert(0,"1.15")
    width_entry.insert(0, "350")
    color_entry.insert(END, "0.2")
    color_const_entry.insert(END, "0.3")
...
draw_button = Button(root, text=" Draw Mandelbort Set ", width = "20", height = "1", command=draw_mandelbort)
